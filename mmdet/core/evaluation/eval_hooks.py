    ...
    def after_train_epoch(self, runner):
        ...
        if runner.rank == 0:
            ...
            for i in range(1, runner.world_size):
                ...
                # tmp_results = pickle.load(tmp_file)
...
class DistEvalmAPHook(DistEvalHook):
    ...
    def evaluate(self, runner, results):
        ...
        for i in range(len(self.dataset)):
            ...
            # 'bboxes', 'labels', 'obj_ids', 'bboxes_ignore', 'masks', 'seg_map'
            # print('ann: {}, ann.keys:{}'.format(ann, ann.keys()))
            bboxes = ann['bboxes']
            labels = ann['labels']
            ...
            # print('bboxes: {}, bboxes.size(): {}'.format(bboxes, bboxes.shape))
            # print('labels: {}, labels.size(): {}'.format(labels, labels.shape))
...
class CocoDistEvalmAPHook(DistEvalHook):
    ...
    def evaluate(self, runner, results):
        ...
        result_files = results2json(self.dataset, results, tmp_file, res_types)

# model settings
model = dict(
    type= 'VPS_Temporal_Slots',    #' 'PanopticTrack'
...
load_from = './work_dirs/cityscapes_vps/track_capsule_stg6_100_c20_dhifuse_noft_nofb_8001600_e12_05_d256_possine_dgm_ms1222afdcat256_p816_nmvr612_newlff2ebusefbch_lrddb_v100g8v2/epoch_9_rename.pth'

...
import pickle
import json
from mmdet.utils import get_model_parameters_number
...
def main():
    ...
    print("========================")
    print("Model Params : {}".format(get_model_parameters_number(model)))
    print("========================")
